...
const (
	...
	// context. 64 KB (~16-20k tokens) covers even large diagnostic dumps
	// (container logs, patch dry-runs) while guaranteeing a multi-iteration
	// run fits the upstream model's ~128k-token context window; anything
